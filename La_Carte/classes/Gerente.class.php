...
<?php
    class Gerente extends Super{
        ...
        public function inserir(){
            $sql = 'INSERT INTO gerente (nome, dataNasc, cpf, email, senha) 
        ...
        public function editar(){
            $sql = 'UPDATE gerente SET nome = :nome, dataNasc = :dataNasc, cpf = :cpf, email = :email, senha = :senha 
            WHERE id = :id';
            $parametros = array(":nome"=> $this->getNome(),
                                ":dataNasc"=> $this->getDataN(),
                                ":cpf"=> $this->getCPF(),
        ...
        public static function efetuarLogin($email, $senha){
            $sql = "SELECT id, nome FROM gerente WHERE email = :email AND senha = :senha";
            $parametros = array(
                ':email' => $email,
                ':senha' => $senha,
            );
