...
<table class="tab">
    ...
    <tr>
    <?php
        $lista = Cozinheiro::listar($cnst, $procurar);
    ...
    ?>
            ...
            <td><a href='../cadastro/cadCozinheiro.php?acao=editar&id=<?php echo $linha['id'];?>'><img src='../img/edit.svg'></a></td>
            <td><?php echo " <a href=javascript:excluirRegistro('../acao/acaoCozinheiro.php?acao=excluir&id={$linha['id']}')>
