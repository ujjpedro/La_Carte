...
<table class="tab">
    ...
    <tr>
    <?php
        $lista = Gerente::listar($cnst, $procurar);
    ...
    ?>
            ...
            <td><a href='../cadastro/cadGerente.php?acao=editar&id=<?php echo $linha['id'];?>'><img src='../img/edit.svg'></a></td>
            <td><?php echo " <a href=javascript:excluirRegistro('../acao/acaoGerente.php?acao=excluir&id={$linha['id']}')>
