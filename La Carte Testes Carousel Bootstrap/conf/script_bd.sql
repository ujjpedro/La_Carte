...
CREATE TABLE IF NOT EXISTS `menu`.`pratos` (
  ...
  `pedidos_cliente_id` INT NOT NULL,
  `pedidos_cozinheiro_id` INT NOT NULL,
  PRIMARY KEY (`idPrat`),
  INDEX `fk_pratos_categorias1_idx` (`categorias_id` ASC),
  INDEX `fk_pratos_gerente1_idx` (`gerente_id` ASC),
  INDEX `fk_pratos_pedidos1_idx` (`pedidos_idPed` ASC, `pedidos_cliente_id` ASC, `pedidos_cozinheiro_id` ASC),
